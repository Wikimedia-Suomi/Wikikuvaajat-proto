...
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:8001').split(',')
...
SOCIAL_AUTH_MEDIAWIKI_CALLBACK = os.getenv('SOCIAL_AUTH_MEDIAWIKI_CALLBACK', 'http://localhost:8000/oauth/complete/mediawiki/')
...
LOCAL_DEV_MEDIAWIKI_ACCESS_TOKEN = os.getenv(
    ...
    os.getenv('WIKIMEDIA_OAUTH1_ACCESS_TOKEN', ''),
).strip()
LOCAL_DEV_MEDIAWIKI_ACCESS_SECRET = os.getenv(
    'LOCAL_DEV_MEDIAWIKI_ACCESS_SECRET',
    os.getenv('WIKIMEDIA_OAUTH1_ACCESS_SECRET', os.getenv('WIKIMEDIA_OAUTH1_ACCESS_TOKEN_SECRET', '')),
).strip()
